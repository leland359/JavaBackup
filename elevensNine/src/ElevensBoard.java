...
public class ElevensBoard extends Board {
	...
	public boolean isLegal(List<Integer> selectedCards) {
		if (selectedCards.size() == 2) {
            ...
            //true if the two selected cards values add up to 11
            
		} else if (selectedCards.size() == 3) {
            return containsJQK(selectedCards);
            //true if the three cards are jack queen + king
            
        } else {
        	return false;
        	//selected cards are not a match
        }
    }
	...
	private boolean containsPairSum11(List<Integer> selectedCards) {
        ...
        //if the two cards do not value 11,
        return false;
    }	
	...
	private boolean containsJQK(List<Integer> selectedCards) {
        ...
        //true if all of the has___ are true
        //if one of them is still false, returns false
    }
}
